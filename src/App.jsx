...
function App() {
    const estudiantes = [
        { id: 1, nombre: "Santi Peinado", carrera: "Ingenieria de Sistemas", edad: 21 },
        { id: 2, nombre: "San Flores", carrera: "Ingenieria de Sistemas", edad: 22 },
        { id: 3, nombre: "Dibu Martínez", carrera: "Ingenieria de Sistemas", edad: 23 }
    ];
    return (
        ...
        <>
            ...
            <Asistencia nombre="Dibu Martínez"asistencias={8} />
            <br />
            <Asistencia2 nombre="Santi Peinado"asistencias={10} />
            <Asistencia2 nombre="San Flores"asistencias={5} />
            <Asistencia2 nombre="Dibu Martínez"asistencias={8} />
            <br />
